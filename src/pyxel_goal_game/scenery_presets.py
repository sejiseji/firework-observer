...
CITY_BUILDINGS = (
    ...
    (-0.18, 0.08, 0.12, 0.14, 0.30),
    (-0.18, 0.62, 0.12, 0.13, 0.15),
    (0.18, -0.48, 0.11, 0.12, 0.14),
    (0.19, 0.40, 0.14, 0.16, 0.17),
    ...
    (-0.94, -0.12, 0.08, 0.10, 0.11),
    (-0.86, 0.18, 0.09, 0.10, 0.12),
    (-0.80, -0.58, 0.09, 0.11, 0.12),
    (-0.69, -0.58, 0.10, 0.11, 0.14),
    (-0.56, -0.62, 0.09, 0.10, 0.12),
    (-0.46, 0.70, 0.09, 0.10, 0.12),
    (-0.42, -0.70, 0.10, 0.11, 0.14),
    (-0.27, 0.72, 0.09, 0.10, 0.13),
    (0.17, 0.72, 0.09, 0.10, 0.12),
    (0.31, 0.72, 0.09, 0.10, 0.13),
    (0.43, -0.66, 0.10, 0.11, 0.14),
    (0.55, -0.68, 0.09, 0.10, 0.12),
    (0.67, -0.58, 0.10, 0.11, 0.13),
    (0.78, 0.52, 0.09, 0.10, 0.12),
    (0.86, -0.04, 0.09, 0.10, 0.12),
    (0.94, 0.30, 0.08, 0.10, 0.11),
)
...
def city_scenery(profile: ScreenProfile) -> SceneryPreset:
    ...
    base_y = -0.96
    for index, (center_x, center_z, width, depth, height) in enumerate(CITY_BUILDINGS):
        top_y = base_y + height
    ...
    lines.extend(city_sign_lines(profile=profile, buildings=CITY_BUILDINGS, base_y=base_y))
