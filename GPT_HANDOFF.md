...
- Recommended runtime extraction sequence from here: `T0005.4` first official runtime app and entrypoint without touching `main.py`, then `T0005.5` runtime parity review and `main.py` handoff decision.
