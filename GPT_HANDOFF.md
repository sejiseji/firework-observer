...
- Recommended runtime sequence from here: `T0005.5` runtime parity review and `main.py` handoff decision. Do not modify `main.py` unless a later task explicitly authorizes it.
