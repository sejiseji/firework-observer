...
- `T0008.3.1` tuned only `Long Willow` long-branch trail decay. Long branch particles keep about 56 frames of trail history and draw older rear sections sparsely broken. Baseline Willow, shell tail, global glitter, palette variants, CITY, stars, UFO, and audio remain unchanged.
